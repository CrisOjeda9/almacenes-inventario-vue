        ...
        <div class="sub-navbar">
            ...
            <div  v-if="userRole === 'Inventario' || userRole === 'Administrador'" class="nav-item" @mouseenter="showMenu('homeMenu')" @mouseleave="hideMenu('homeMenu')">
                ...
                <div class="dropdown-menu" v-show="menus.homeMenu">
                    ...
                    <button @click="navigateTo('reportes')" style="background-color: #ddc9a3; color: #691b31; border-radius: 4px;">Generación de reportes</button>
            ...
            <div v-if="userRole === 'Almacen' || userRole === 'Administrador'" class="nav-item" @mouseenter="showMenu('reportesMenu')" @mouseleave="hideMenu('reportesMenu')">
                Almacen
                <span class="menu-icon">▼</span>
                <div class="dropdown-menu" v-show="menus.reportesMenu">
